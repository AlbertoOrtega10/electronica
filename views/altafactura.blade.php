...
<form action = "{{route('guardarfactura')}}" method = "POST" enctype= 'multipart/form-data'>
    {{csrf_field()}}
      <div class="col-lg-12">
         <div class="card">
            ...
            <div class="card-body card-block">
                <div class="row">
                    ...
                    @endif              
                    <input type="text" name="idf" id="idf" value="{{$idsigue}}" readonly='readonly' class="form-control" placeholder="clave" tabindex="0">
                     </label>
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    @endif  
                    <input type="text" name="rfc" id="rfc" value="{{old('rfc')}}" class="form-control" placeholder="rfc" tabindex="3">
                </div>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    @endif  
                    <input type="text" name="domicilio" id="domicilio" value="{{old('domicilio')}}"class="form-control" placeholder="domicilio" tabindex="7">
                </div>
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6">
